...
const PlayerList = () => {
  const teamMembers = [
    ...
    { id: 6, name: "Deepak", points: 3 },
    { id: 7, name: "Giridharan", points: 1.5 },
    { id: 8, name: "Jeffrin", points: 3 },
    { id: 9, name: "Krish", points: 3 },
    { id: 10, name: "KumarSelvam", points: 4 },
    { id: 11, name: "MuraliK", points: 4 },
    { id: 12, name: "Naveen", points: 1.5 },
    { id: 13, name: "Nirmal", points: 4 },
    { id: 14, name: "Prabhakaran", points: 4 },
    { id: 15, name: "Pravin", points: 3 },
    { id: 16, name: "Sarath", points: 4 },
    { id: 17, name: "Sarathy", points: 3 },
    { id: 18, name: "Selvendran", points: 4 },
    { id: 19, name: "Sikkandar", points: 4 },
    { id: 20, name: "SivaDurai", points: 3 },
    { id: 21, name: "ThiruVarasan", points: 3 },
    { id: 22, name: "VelMurugan", points: 4 },
  ];
