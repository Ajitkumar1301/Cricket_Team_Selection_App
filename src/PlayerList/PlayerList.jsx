...
const PlayerList = () => {
  const teamMembers = [
    ...
    { id: 7, name: "Devaraj", points: 2.5 },
    { id: 8, name: "Giridharan", points: 1 },
    { id: 9, name: "Jeffrin", points: 2 },
    { id: 10, name: "Jones", points: 2 },
    { id: 11, name: "Krish", points: 3 },
    { id: 12, name: "KumarSelvam", points: 2 },
    { id: 13, name: "MuraliK", points: 4 },
    { id: 14, name: "Naveen", points: 1 },
    { id: 15, name: "Nirmal", points: 4 },
    { id: 16, name: "Prabhakaran", points: 4 },
    { id: 17, name: "Pravin", points: 1.5 },
    { id: 18, name: "Sakthivel", points: 2.5 },
    { id: 19, name: "Sarath", points: 4 },
    { id: 20, name: "Sarathy", points: 3 },
    { id: 21, name: "Selvendran", points: 4 },
    { id: 22, name: "Sikkandar", points: 3 },
    { id: 23, name: "SivaDurai", points: 2.5 },
    { id: 24, name: "ThiruVarasan", points: 1.5 },
    { id: 25, name: "VelMurugan", points: 4 },
    { id: 26, name: "Vignesh", points: 1.5 },
  ];
